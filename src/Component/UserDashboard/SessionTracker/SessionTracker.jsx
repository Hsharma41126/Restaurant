        ...
        const fetchSessionData = async () => {
            try {
                ...
                if (data.success && data.data.sessions.length > 0) {
                    ...
                    // Calculate elapsed seconds based on start time
                    ...
                    // Calculate total seconds based on duration
                    ...
                    <div className="bg-white rounded-3 shadow-sm p-4">
                        <div className="row g-3">
                            ...
                            <div className="col-md-4">
                                <div className="text-muted small mb-1">Status</div>
                                <span className="badge bg-success rounded-pill" style={{ width: '8px', height: '8px' }}></span>
                                <span className="text-success fw-medium text-capitalize">{sessionData.status}</span>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div className="bg-white rounded-3 shadow-sm p-4">
                                ...
                                <div className="d-flex flex-column gap-2">
                                    ...
                                    <div className="d-flex justify-content-between">
                                        <span className="text-muted">Total Duration</span>
                                        <span className="fw-medium font-monospace">
                                            {formatTime(sessionData.duration_minutes * 60)}
                                        </span>
                                    </div>
                                    <div className="d-flex justify-content-between">
                                        <span className="text-muted">Rate</span>
