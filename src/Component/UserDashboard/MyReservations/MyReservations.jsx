                    ...
                    onClick={async () => {
                      try {
                        ...
                        await axios.patch(
                          ...
                          `https://ssknf82q-6100.inc1.devtunnels.ms/api/reservations/${currentBookingId}/cancel`,
                          {},
                          {
                            headers: {
                              Authorization: `Bearer ${token}`,
                    ...
                    onClick={async () => {
                      try {
                        ...
                        await axios.put(
                          ...
                          `https://ssknf82q-6100.inc1.devtunnels.ms/api/reservations/${currentBookingId}`,
                          payload,
                          {
                            headers: {
                              Authorization: `Bearer ${token}`,
                        ...
                        await axios.patch(
                          ...
                          `https://ssknf82q-6100.inc1.devtunnels.ms/api/reservations/${currentBookingId}/status`,
                          { status: "confirmed" },
                          {
                            headers: {
                              Authorization: `Bearer ${token}`,
