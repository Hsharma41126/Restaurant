...
//       try {
//         setLoading(true);
//         const response = await axios.get('https://ssknf82q-6100.inc1.devtunnels.ms/api/business_settings');
...
//         // Set business hours
//         setBusinessHours({
//           weekdays: { start: data.weekdays_start, end: data.weekdays_end },
//           saturday: { start: data.saturday_start, end: data.saturday_end },
//           sunday: { start: data.sunday_start, end: data.sunday_end }
//         });
...
//         weekdays_start: businessHours.weekdays.start,
//         weekdays_end: businessHours.weekdays.end,
...
//           {error}
//         </div>
//         {/* Render the rest of the component with default values */}
//       </div>
//     );
//   }
